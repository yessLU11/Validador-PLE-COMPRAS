...
# Estilo CSS personalizado - Diseño profesional moderno
st.markdown("""
<style>
    /* Variables de color */
    :root {
...
with st.sidebar:
    ...
    if meses:
        ...
        st.markdown(f'<div class="stat-box"><div class="stat-number">{len(meses)}</div><div class="stat-label">de {MESES_A_MANTENER} meses</div></div>', unsafe_allow_html=True)
...
# Pie de página
st.markdown("---")
st.caption("🔐 **Seguridad**: Datos locales en SQLite. Sin conexiones externas. | v2.1 - UI Mejorada")
